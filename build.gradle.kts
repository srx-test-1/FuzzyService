...
dependencies {
    ...
    implementation ("org.apache.logging.log4j:log4j-core:2.17.1") // Patched for CVE-2021-44228 (Log4Shell)
    implementation ("org.apache.logging.log4j:log4j-api:2.17.1") // Patched for CVE-2021-44228 (Log4Shell)
