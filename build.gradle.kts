...
dependencies {
    ...
    // Spring Boot 2.6.6 includes Spring Framework 5.3.18, which patches CVE-2022-22965 (Spring4Shell)
    implementation ("org.springframework.boot:spring-boot-starter-web:2.6.6")

    // Upgrade to Log4j2 2.17.1 to resolve Log4Shell vulnerabilities (CVE-2021-44228, CVE-2021-45046, CVE-2021-45105)
